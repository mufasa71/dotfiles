...
class CustomApplications(Applications):
	def app_default(self, c):
		...
		if f.video or f.audio:
			if f.video:
				c.flags += 'd'
			return self.either(c, 'vlc', 'mplayer', 'mplayer2', 'smplayer', 'totem')
...
CustomApplications.generic('chromium', 'firefox', 'apvlv', 'evince',
